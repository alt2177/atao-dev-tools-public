...
keymap.set("n", "<leader>ro", ":MagmaShowOutput<CR>")
...
keymap.set("n", "<leader>ef", ":NvimTreeFindFileToggle<CR>") -- toggle file explorer on current file
keymap.set("n", "<leader>ec", ":NvimTreeCollapse<CR>") -- collapse file explorer
